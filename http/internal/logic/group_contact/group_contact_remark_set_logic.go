...
type GroupContactRemarkSetLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewGroupContactRemarkSetLogic(ctx context.Context, svcCtx *svc.ServiceContext) *GroupContactRemarkSetLogic {
	return &GroupContactRemarkSetLogic{
...
func (l *GroupContactRemarkSetLogic) GroupContactRemarkSet(req *types.GroupContactStringSetReq) error {
